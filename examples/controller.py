...
humaneval_sample_num=None

def main(args=None):
    global humaneval_result_path,humaneval_sample_num
    if args is None:
    ...
    humaneval_sample_num = int(args.sample_num)
    if args.stage == "all":
...
def run_humaneval_evaluation(model_path_or_model, tokenizer=None, accelerator=None, eval_result_path=None):
    ...
    try:
        ...
        num_samples_per_task = humaneval_sample_num  # Standard for HumanEval
